   ...
   width = '1000'
      ...
      <Button
         ...
         onPress={() => navigation.navigate('Signup')}/>
            <Text style={{color:"grey", margin:10, alignSelf:"center"}}>----------------or signup with----------------</Text>
         <View
            style={{
              flexDirection: 'row',
              ...
              <SocialIcon 
              type="google"
                  onPress={() => {Linking.openURL('https://accounts.google.com/signin/v2/identifier?continue=https://mail.google.com/mail/&service=mail&sacu=1&rip=1&flowName=GlifWebSignIn&flowEntry=ServiceLogin'); }}
                /></View>
     </View>
 </View>  
